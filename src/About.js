  ...
  render() {
    return (
      <div className="about">
        ...
        <br/>
        <br/>
        I'm currently a Teaching Fellow and Engineer at Fullstack Academy, and I'm looking for new opportunities in software engineering (<a className="resume-link" href="/resume.pdf" target="blank" >resume</a>)
        <br/>
        <br/>
          - Beth 
          </p>
